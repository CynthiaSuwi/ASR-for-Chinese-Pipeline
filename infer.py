...
# yapf: disable
add_arg('num_samples',      int,    30,     "# of samples to infer.")
...
def infer():
    ...
    for target, result in zip(target_transcripts, result_transcripts):
        print("\nTarget Transcription: %s\nOutput Transcription: %s" %
              (target.encode('utf-8'), result.encode('utf-8')))
        print("Current error rate [%s] = %f" %
              (args.error_rate_type, error_rate_func(target.encode('utf-8'), result.encode('utf-8'))))
